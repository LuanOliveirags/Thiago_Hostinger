// app/init.js — orquestrador de todos os módulos

import { initMenu } from '../features/menu/menu.js';
import { initHeader } from '../features/header/header.js';
import { initPreloader } from '../features/preloader/preloader.js';
import { initModalImage } from '../features/resultados/modal-image.js';
import { initCarouselFeedback } from '../features/feedbacks/carousel-feedback.js';
import { initFaq } from '../features/faq/faq.js';
import { initResultados } from '../features/resultados/resultados.js';
import { initFeedbacks } from '../features/feedbacks/feedbacks.js';
import {
  initAnalytics,
...
function initForWhoCardsHighlight() {
  ...
  const blocks = Array.from(
    document.querySelectorAll(
      '.forwho-card, .forwho-bad-modern, .forwho-good-modern, .process-card'
    )
  );
...
function initRevealObserver() {
  const revealElements = document.querySelectorAll(
    '.hero-content, .about-content, .process-card, .skill-card-modern, .portfolio-item'
  );
